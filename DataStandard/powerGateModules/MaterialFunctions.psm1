...
$materialNumberEntitySet = "MaterialNumbers"
...
function CreateMaterialBase($material) {
	if($null -eq $material.Number -or $material.Number -eq ""){
		$material.Number = GetNewErpMaterialNumber
	}
	$material = TransformMaterial -material $material
...
function GetNewErpMaterialNumber()
{
	$newMaterialNumber = Get-ErpObjects -EntitySet $materialNumberEntitySet
	$newMaterialNumber = CheckResponse -entity $newMaterialNumber
	return $newMaterialNumber.NextNumber
}
